...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):  # 前向传播
        ...
        images, targets = self.transform(images, targets)  # 对图像进行预处理，这才是backbone处理的数据
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,  # 目标类别个数是要加上背景的
                 # transform parameter
                 ...
                 # 如果图像目标数较多可以设置大于100，这是最后的结果中使用nms的阈值
