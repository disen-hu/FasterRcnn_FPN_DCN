...
def create_model(num_classes):
    ...
    backbone = MobileNetV2(weights_path="./backbone/mobilenet_v2-b0353104.pth").features
...
def main():
    ...
    '''指定VOC数据集的根目录,如果放在faster——rcnn目录下可以用：VOC_root = os.getcwd()'''
    VOC_root = "./"  # VOCdevkit
    ...
    optimizer = torch.optim.SGD(params, lr=0.005,
                                momentum=0.9, weight_decay=0.0005)  # 优化器使用的是SGD
