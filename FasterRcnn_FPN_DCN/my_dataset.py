...
class VOCDataSet(Dataset):
    ...
    '''voc_root训练集所在的根目录，transforms是预处理方法'''
    def __init__(self, voc_root, year="2012", transforms=None, txt_name: str = "train.txt"):
        ...
        '''通过for循环遍历每一行，去掉换行符,得到train.txt里面对应的xml文件名'''
        ...
        # read class_indict
        '''json路径并放入class_dict'''
        json_file = './pascal_clc_classes.json'
...
# category_index = {}
# try:
#     json_file = open('./pascal_clc_classes.json', 'r')
