...
def main(parser_data):
    ...
    model.load_state_dict(torch.load(weights_path,map_location={'cuda:1':'cuda:0'})['model'])
    # print(model)
...
if __name__ == "__main__":
    ...
    # 训练好的权重文件
    parser.add_argument('--weights-path', default='backbone/best_map81_def3.pth', type=str, help='training weights')
